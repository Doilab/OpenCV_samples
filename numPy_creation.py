...
# Action 1b: img_1 の画像全体を白，一部を青で塗る．
img_1[:] = (255, 255, 255)
img_1[100:200] = (255, 0, 0)
image_info(img_1, 'img_1', 'Part it blue')
...
image_info(img_3, 'img_3', 'Create 1-channnel/uint8 image: Paint it brack')

# Action 4: 全体が1の画像からグレー(200)の画像を生成
img_4 = np.ones((400, 600), np.uint8) * 200
image_info(img_4, 'img_4', 'Create 1-cannel/uint8 image: Start form 1, then 200')
